...
# or that the program is running for the first time. We should modify it in case the current user is not the person
# who last used the program. Before printing a welcome back message in greet_user(),
